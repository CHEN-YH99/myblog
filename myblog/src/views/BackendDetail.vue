<template>
  <div class="backend-detail-wrapper">
    <!-- 头部大图 -->
    ...
    case '后端语言':
      return [
        ...
        },
        {
          ...
          title: 'Python',
          image: 'icon-python',
          content: 'Python 是数据科学和Web开发的热门语言',
        ...
        },
        {
          ...
          title: 'Node.js',
          image: 'icon-node-js',
          content: 'Node.js 让JavaScript运行在服务端',
      ...
      return [
        {
          id: nanoid(),
          title: 'Spring Boot',
          image: 'icon-spring-boot',
          content: 'Java生态最流行的微服务框架',
          url: 'https://spring.io/projects/spring-boot/',
        },
        {
          id: nanoid(),
          title: 'Django',
          image: 'icon-diangonggongqian',
          content: 'Python的全功能Web开发框架',
          url: 'https://www.djangoproject.com/',
        },
        {
          id: nanoid(),
          title: 'Docker',
          image: 'icon-rongqiDoker',
          content: '容器化部署和管理工具',
    ...
    case '大模型开发':
      return [
        ...
        },
        {
          ...
          content: 'Hugging Face的预训练模型库',
          url: 'https://huggingface.co/docs/transformers/index',
        },
        {
          id: nanoid(),
          title: 'OpenAI API',
          image: 'icon-openai-fill',
          content: 'OpenAI提供的GPT模型接口',
        ...
        },
        {
          ...
          title: 'LlamaIndex',
          image: 'icon-XML',
          content: '构建LLM应用的数据框架',
          url: 'https://docs.llamalab.com/llamaindex/',
        },
      ]
    case '推荐网站':
      return [
        ...
        },
        {
          ...
          content: '全球最大的代码托管和协作平台',
          url: 'https://github.com/',
        },
        {
          id: nanoid(),
          title: 'Docker Hub',
          image: 'icon-docker_hub_fill',
          content: '容器镜像的官方仓库',
...
html.dark .backend-detail-wrapper {
