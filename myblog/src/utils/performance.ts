...
// 组件懒加载
export function lazyLoadComponent(importFunc: () => Promise<any>, delay = 200): Promise<any> {
...
export function createAsyncComponent<T>(
  ...
  const { delay = 200, timeout = 10000, errorComponent = null, loadingComponent = null } = options
