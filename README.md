...
### 管理端
 。。。
### 前台博客展示
- 🌐 **在线访问**: [https://www.xhui886.online](https://www.xhui886.online) (生产环境) | [本地开发](http://localhost:5173)
- 📱 **响应式设计**: 支持桌面端和移动端访问
- 🎨 **现代化UI**: 简洁美观的用户界面，支持暗黑模式
- ✨ **动画效果**: 流畅的页面过渡和交互动画
- 🔍 **全文搜索**: 支持文章内容全文搜索和关键词高亮
- 💬 **互动功能**: 文章点赞、浏览量统计、评论功能

### 后台管理系统
- 🔧 **访问地址**: [https://www.xiaohui88.site](https://www.xiaohui88.site)(生产环境) | [本地开发](http://localhost:5174) 
